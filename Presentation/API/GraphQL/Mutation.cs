...
{
    public async Task<Product> CreateProduct(CreateProductDto input, [Service] ApplicationDbContext db)
    {
    ...
    public async Task<Product?> UpdateProduct(int id, CreateProductDto input, [Service] ApplicationDbContext db)
    {
